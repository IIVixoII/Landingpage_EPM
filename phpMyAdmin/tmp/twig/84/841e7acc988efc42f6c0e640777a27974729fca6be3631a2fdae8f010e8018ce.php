...
class __TwigTemplate_6facbddfe9c614cba76c265dfb34f45b52fa5acabdba7de0f2daf85a300e3306 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Variables");
      ...
      ";
        ...
        ";
                    // line 26
                    if (((isset($context["page"]) || array_key_exists("page", $context)) && (0 === twig_compare(($context["page"] ?? null), $context["current"])))) {
                        // line 27
                        echo "          <strong>";
...
";
    ...
    {
        return new Source("", "server/engines/show.twig", "/var/www/html/phpMyAdmin/templates/server/engines/show.twig");
    }
}
